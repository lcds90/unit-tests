...
describe('todo tests', () => {
  ...
  it('should render console', () => {
    console.log('🔧 Use mount() para renderizar um componente e ter sua instância.')
    console.log('🔍 Use get() e findAll() para consultar o DOM.')
    console.log('🖱️ trigger() e setValue() são auxiliares para simular a entrada do usuário.')
    console.log('🔄 Atualizar o DOM é uma operação assíncrona, então certifique-se de usar async e await.')
    console.log('✅ Testar geralmente consiste em 3 fases: organizar, agir e afirmar.')
  })
})
